    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:hidden animate-fade-in">
      <div className="flex-1 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm z-10 animate-slide-up">
          <div className="bg-white rounded-2xl shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] p-5 border border-slate-100/50 backdrop-blur-sm">
            <div className="text-center mb-5">
              <div className="mb-4 inline-flex items-center justify-center rounded-[1.125rem] border border-slate-200 bg-slate-50/80 px-4 py-3 shadow-sm">
                <img src={logoUrl} alt="Logo UKM Kemasan" className="h-10 w-auto object-contain" />
              </div>
              <h1 className="text-2xl font-black text-slate-800 tracking-tight font-headline">Welcome Back</h1>
              <p className="mt-1.5 text-slate-500 font-medium text-xs">Masuk untuk melanjutkan pesanan Anda</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5 group">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full text-slate-800 px-3.5 py-3 bg-slate-50 border-b-2 border-transparent rounded-xl focus:outline-none focus:border-[#4dbace] focus:bg-white transition-all font-medium placeholder:text-slate-300 shadow-sm text-sm"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 group">
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full text-slate-800 px-3.5 py-3 pr-11 bg-slate-50 border-b-2 border-transparent rounded-xl focus:outline-none focus:border-[#4dbace] focus:bg-white transition-all font-medium placeholder:text-slate-300 shadow-sm text-sm"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="pt-2">
                <button 
                  type="submit" 
                  disabled={loading}
                  className="w-full bg-[#4dbace] hover:opacity-90 text-white py-3.5 rounded-xl font-black text-xs uppercase tracking-[0.2em] shadow-lg shadow-[#4dbace]/20 active:scale-[0.98] disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                >
              ...
              <button 
                ...
                className="w-full bg-white border border-slate-200 text-slate-700 py-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 hover:bg-slate-50 active:scale-[0.98] transition-all"
              >
                Masuk Sebagai Tamu
              </button>
            </form>
