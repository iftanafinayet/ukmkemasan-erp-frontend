...
const SplashScreen = () => {
  ...
  return (
    <Motion.div
      ...
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-primary text-white overflow-hidden"
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[280px] text-center">
        ...
        >
          <div className="bg-surface-container-lowest p-7 rounded-[2rem] shadow-modal flex items-center justify-center">
            <img
              src={logo}
              alt="Logo"
        ...
        <Motion.div
           ...
           className="mb-14"
        >
          <h1 className="text-2xl font-bold tracking-[0.2em] uppercase mb-1">UKM Kemasan</h1>
        ...
        <div className="h-5 mb-8">
          <AnimatePresence mode="wait">
            <Motion.p
              ...
              className="font-semibold text-[12px] tracking-widest uppercase"
            >
      ...
      >
        <p className="text-[10px] font-bold uppercase tracking-[0.3em]">Official Mobile App</p>
