  ...
  return (
    <div className="min-h-screen flex w-full bg-white font-sans overflow-hidden animate-fade-in">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary items-center justify-center p-12 overflow-hidden">
        ...
        {/* Diagonal Gradient overlay for more depth */}
      ...
      {/* Right Panel: Clean login card with subtle background detail */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-slate-50 relative overflow-hidden">
        ...
        <div className="w-full max-w-[500px] z-10 px-4 md:px-0 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <div className="bg-white rounded-[1.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] p-10 md:p-14 border border-slate-100/50 backdrop-blur-sm">
